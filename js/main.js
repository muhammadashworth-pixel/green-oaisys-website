...
(function () {
  ...
  const I18N = {
    ...
    ar: {
      ...
      hero_h1: '<span class="accent">أنظمة</span> و<span class="accent">وكلاء ذكاء اصطناعي</span> بمستوى عالمي — منشأتك الصغيرة تنافس الكبار.',
      hero_sub: 'نبني لك أنظمة واضحة وبسيطة، فريقك يرتاح لها ويستخدمها من أول يوم، ونشغّل معها وكلاء ذكاء اصطناعي. تختفي الفوضى وتنتهي شغلات آخر لحظة، ويصير كل شي يمشي بثبات وهدوء — أساس متين يخلّيك تكبر بسرعة، وتتحوّل من منشأة إلى علامة، وتنجز أكثر بنفس فريقك.',
