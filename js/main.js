...
(function () {
  ...
  const I18N = {
    en: {
      ...
      bl_sub: "Just an idea, or a one-person show? We'll help you start right — brand, systems, and tools built in from day one, so you're building a brand with real value, not just another business. And we grow with you from there.",
    ...
    ar: {
      ...
      bl_sub: "مجرد فكرة، أو تشتغل لحالك؟ بنساعدك تبدأ صح — علامة، وأنظمة، وأدوات مبنية من أول يوم، عشان تبني علامة لها قيمة حقيقية، مو مجرد عمل عادي. ونكبر معك من هناك.",
