...
(function () {
  ...
  const I18N = {
    ...
    ar: {
      ...
      hero_sub: 'أول شي، نبني لك الأنظمة اللي تخلّي شغلك يمشي مثل الساعة — منظّم، ثابت، وأخيرًا تحت السيطرة. وبعدها نضاعف أداءه بوكلاء ذكاء اصطناعي وسير عمل ذكي يشيلون عنك الحِمل، عشان تسبق منافسينك وتكبر بسرعة.',
