...
(function () {
  ...
  const I18N = {
    en: {
      ...
      nav_blog: "Blog",
      proof_kicker: "See it in action",
      proof_h2: "How we'd fix a business like yours.",
      proof_sub: "We're new — so instead of borrowed logos, here are honest, worked examples of Riyadh businesses like yours: the daily chaos, what we'd build, and the result you'd feel.",
    ...
    ar: {
      ...
      nav_blog: "المدوّنة",
      proof_kicker: "شوفها على أرض الواقع",
      proof_h2: "كيف نصلح منشأة مثل منشأتك.",
      proof_sub: "إحنا جدد — فبدل شعارات مستعارة، هذي أمثلة صادقة لمنشآت في الرياض مثل منشأتك: الفوضى اليومية، وش نبنيه، والنتيجة اللي بتحسّها.",
