...
(function () {
  ...
  const I18N = {
    en: {
      ...
      hero_h1: '<span class="accent">Systems</span> that run your business. <span class="accent">AI agents</span> that do the work of a bigger team.',
      hero_sub: "We build clear, simple systems your team actually likes using — then add AI agents that multiply what they get done. The mess, the WhatsApp chaos, the last-minute scrambles: gone. What's left is a calm business with the room to grow.",
      ...
      vision_text: 'To embed systems excellence and AI fluency into the DNA of every Saudi business.',
      ...
      stats_foot: "The businesses pulling ahead are the ones pairing AI with systems their people actually use. That's exactly what we build.",
    ...
    ar: {
      ...
      hero_h1: '<span class="accent">أنظمة</span> تشغّل منشأتك، <span class="accent">ووكلاء ذكاء اصطناعي</span> ينجزون شغل فريق أكبر.',
      hero_sub: 'نبني أنظمة واضحة وبسيطة فريقك يرتاح لها، ونضيف وكلاء ذكاء اصطناعي يضاعفون إنجازهم. الفوضى، وزحمة الواتساب، والشغل بلحظته الأخيرة — كلها تروح. واللي يبقى منشأة هادية عندها متسع تكبر فيه.',
      ...
      vision_label: 'رؤيتنا',
      vision_text: 'نزرع تميّز الأنظمة وطلاقة الذكاء الاصطناعي في جينات كل منشأة سعودية.',
      ...
      stats_foot: 'المنشآت اللي تسبق هي اللي تجمع الذكاء الاصطناعي مع أنظمة يستخدمها فريقها فعلًا. وهذا بالضبط اللي نبنيه.',
