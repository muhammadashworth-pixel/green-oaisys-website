...
(function () {
  ...
  const I18N = {
    en: {
      ...
      bl_eyebrow: "Just starting out?",
      bl_h2: "Build it right from day one.",
      bl_sub: "Not every business we work with is already up and running. Some are just an idea, or a founder doing everything themselves. If that's you, we'll help you start the right way — building your brand, your systems, and the tools to grow on from the very beginning. Systemising early doesn't only keep you organised; it builds real value into the business from day one, turning what you're starting into a brand rather than just another business. And we do it alongside you — as your outsourced growth and systemisation partner, building the engine with you and helping it grow.",
      bl1_t: "AI agents that do the work",
      bl1_p: "This is where a small team gains the most. We put AI agents on the jobs you can't yet hire for — replying to enquiries around the clock, chasing follow-ups, drafting quotes and messages in your voice. It's like bringing on your first few staff, without the payroll.",
      bl2_t: "Brand and identity",
      bl2_p: "We give you a brand that looks established from the very start, so customers trust you before they've even spoken to you — and so the value you build carries a name worth remembering.",
      bl3_t: "A sales and service engine that never drops the ball",
      bl3_p: "Every enquiry gets captured, followed up, and answered properly, so leads don't slip away and customers feel looked after, even when it's just you behind it all.",
      bl4_t: "Systems built in from the beginning",
      bl4_p: "Most owners only bring in systems years too late, once the chaos has already taken hold. We build yours in from the start, so the business is organised, consistent, and genuinely valuable long before it gets busy.",
      bl5_t: "The tools and tech, set up properly",
      bl5_p: "We build your website and set up the software behind it, done right the first time, so you can spend your energy on the business instead of wrestling with tools.",
      bl6_t: "A partner that grows with you",
      bl6_p: "We don't disappear once you're live. As you grow, we keep systemising and improving what matters — and we can run and maintain the parts that keep working for you: your website, AI agents, workflows, comms, sales funnel, and more.",
      bl_l1: "Launch", bl_l2: "Systemise", bl_l3: "Scale",
      bl_ladder: "We grow with you — from launch, to systemised, to scaled.",
      bl_line: "Most agencies build you a website and disappear. We build the engine behind it — your brand, your systems, your sales — and grow it with you, so from day one you're building a brand with real value, not just another business.",
      bl_cta: "Book a free call",
      ...
      proof_h2: "We already know how a business like yours runs.",
    ...
    ar: {
      ...
      bl_eyebrow: "لسّا في البداية؟",
      bl_h2: "ابنِها صح من أول يوم.",
      bl_sub: "مو كل عمل نشتغل معه يكون قائم وشغّال. بعضهم مجرد فكرة، أو صاحب عمل يسوّي كل شي بنفسه. إذا هذا وضعك، بنساعدك تبدأ بالطريقة الصح — نبني علامتك، وأنظمتك، والأدوات اللي تكبر عليها من أول يوم. النظمة المبكرة ما تنظّم شغلك بس؛ تبني قيمة حقيقية في العمل من أول يوم، وتحوّل اللي تبدأه إلى علامة تجارية بدل مجرد عمل عادي. وكل هذا نسوّيه معك جنبًا إلى جنب — كشريكك الخارجي في النمو والأنظمة، نبني المحرّك معك ونساعده يكبر.",
      bl1_t: "وكلاء ذكاء اصطناعي يشتغلون عنك",
      bl1_p: "هنا يكسب الفريق الصغير أكثر شي. نحطّ وكلاء الذكاء الاصطناعي على المهام اللي ما تقدر توظّف لها بعد — الرد على الاستفسارات على مدار الساعة، متابعة العملاء، وكتابة العروض والرسائل بأسلوبك. مثل ما توظّف أول موظفينك، بدون رواتب.",
      bl2_t: "الهوية والعلامة التجارية",
      bl2_p: "نعطيك علامة تبان راسخة من أول لحظة، عشان يثق فيك العميل قبل حتى ما يكلّمك — وعشان القيمة اللي تبنيها تحمل اسمًا يستاهل التذكّر.",
      bl3_t: "محرّك مبيعات وخدمة ما يفوّت شي",
      bl3_p: "كل استفسار ينحفظ، ويتابَع، ويُرد عليه صح، عشان ما تضيع الفرص ويحس العميل إنه معتنى فيه — حتى لو كنت لحالك ورا كل شي.",
      bl4_t: "أنظمة مبنية من البداية",
      bl4_p: "أغلب الملّاك يدخلون الأنظمة متأخر سنين، بعد ما تتمكّن الفوضى. نحن نبنيها من البداية، عشان يكون العمل منظّم، وثابت، وله قيمة حقيقية قبل ما ينشغل.",
      bl5_t: "الأدوات والتقنية، مجهّزة صح",
      bl5_p: "نبني موقعك ونجهّز البرامج اللي وراه، صح من أول مرة، عشان تصرف طاقتك على العمل بدل ما تتصارع مع الأدوات.",
      bl6_t: "شريك يكبر معك",
      bl6_p: "ما نختفي بعد ما تنطلق. مع نموّك، نستمر في التنظيم وتحسين اللي يهم — ونقدر نشغّل ونصون الأجزاء اللي تشتغل لك: موقعك، وكلاء الذكاء الاصطناعي، سير العمل، التواصل، قمع المبيعات، وأكثر.",
      bl_l1: "الانطلاق", bl_l2: "الأنظمة", bl_l3: "التوسّع",
      bl_ladder: "نكبر معك — من الانطلاق، إلى الأنظمة، إلى التوسّع.",
      bl_line: "أغلب الوكالات تبني لك موقع وتختفي. نحن نبني المحرّك اللي وراه — علامتك، أنظمتك، مبيعاتك — ونكبّره معك، عشان من أول يوم تبني علامة لها قيمة حقيقية، مو مجرد عمل عادي.",
      bl_cta: "احجز مكالمة مجانية",
      ...
      proof_h2: "نعرف كيف تشتغل منشأة مثل منشأتك.",
