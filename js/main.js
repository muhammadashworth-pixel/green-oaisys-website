...
(function () {
  ...
  const I18N = {
    en: {
      ...
      hero_h1: '<span class="accent">Systems</span> &amp; <span class="accent">AI agents</span> — so a small team runs like a big one.',
    ...
    ar: {
      ...
      hero_h1: '<span class="accent">أنظمة</span> و<span class="accent">وكلاء ذكاء اصطناعي</span> — عشان فريق صغير يشتغل مثل الكبار.',
