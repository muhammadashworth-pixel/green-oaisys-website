...
(function () {
  ...
  const I18N = {
    en: {
      ...
      stats_foot: "This edge won't stay open long. The businesses pairing systems with AI now will be very hard to catch — make sure you're one of them, not the one chasing.",
    ...
    ar: {
      ...
      hero_h1: 'حوّل منشأتك الصغيرة إلى علامة ناجحة — مع <span class="accent">أنظمة</span> و<span class="accent">وكلاء ذكاء اصطناعي</span> بمستوى عالمي.',
      ...
      stats_foot: 'الفرصة هذي ما بتدوم طويل. المنشآت اللي تجمع الأنظمة مع الذكاء الاصطناعي الحين بيصعب اللحاق فيها — خلّك منهم، مو اللي يجري وراهم.',
