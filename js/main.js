...
(function () {
  ...
  const I18N = {
    en: {
      ...
      offers_kicker: "Already up and running?",
      offers_h2: "Pick your starting point.",
      offers_sub: "Two ways to start for small and mid-sized businesses that are already trading. Not sure yet? Get a free diagnosis first. Ready to move? We start building right away.",
      ...
      bl_sub: "Brand new, still just an idea, or a solo founder? We'll help you start right — brand, systems, and tools built in from day one, so you're building a brand with real value, not just another business. And we grow with you from there.",
      bl1_t: "AI agents that do the work",
      bl1_p: "Put AI agents on the work you can't yet hire for — answering enquiries, chasing follow-ups, drafting quotes in your voice. Your first hires, without the payroll.",
      bl2_t: "Brand and identity",
      bl2_p: "A brand that looks established from day one, so customers trust you before they've even spoken to you.",
      bl3_t: "A sales and service engine that never drops the ball",
      bl3_p: "Every enquiry captured, followed up, and answered — so nothing slips and customers feel looked after.",
      bl4_t: "Systems built in from the beginning",
      bl4_p: "The systems most owners add years too late, built in from the start — so you're organised before you're busy.",
      bl5_t: "The tools and tech, set up properly",
      bl5_p: "Your website and the software behind it, set up right the first time — so you focus on the business, not the tools.",
      bl6_t: "A partner that grows with you",
      bl6_p: "We don't disappear once you're live. As you grow, we systemise, improve, and maintain what keeps working for you — website, AI agents, workflows, comms, sales funnel, and more.",
      ...
      proof_h2: "We know where businesses like yours get stuck.",
    ...
    ar: {
      ...
      offers_kicker: "منشأتك قائمة وشغّالة؟",
      offers_h2: "اختر نقطة انطلاقك.",
      offers_sub: "طريقتان للبداية للمنشآت الصغيرة والمتوسطة اللي شغّالة فعلًا. لسّا تستكشف؟ ابدأ بتشخيص مجاني. جاهز تتحرّك؟ نبدأ البناء فورًا.",
      ...
      bl_sub: "منشأة جديدة، لسّا فكرة، أو تشتغل لحالك؟ بنساعدك تبدأ صح — علامة، وأنظمة، وأدوات مبنية من أول يوم، عشان تبني علامة لها قيمة حقيقية، مو مجرد عمل عادي. ونكبر معك من هناك.",
      bl1_t: "وكلاء ذكاء اصطناعي يشتغلون عنك",
      bl1_p: "نحطّ وكلاء ذكاء اصطناعي على الشغل اللي ما تقدر توظّف له بعد — الرد على الاستفسارات، متابعة العملاء، وكتابة العروض بأسلوبك. أول موظفينك، بدون رواتب.",
      bl2_t: "الهوية والعلامة التجارية",
      bl2_p: "علامة تبان راسخة من أول يوم، عشان يثق فيك العميل قبل ما يكلّمك.",
      bl3_t: "محرّك مبيعات وخدمة ما يفوّت شي",
      bl3_p: "كل استفسار ينحفظ، ويتابَع، ويُرد عليه — عشان ما يضيع شي ويحس العميل إنه معتنى فيه.",
      bl4_t: "أنظمة مبنية من البداية",
      bl4_p: "الأنظمة اللي يضيفها أغلب الملّاك متأخر سنين، نبنيها من البداية — عشان تكون منظّم قبل ما تنشغل.",
      bl5_t: "الأدوات والتقنية، مجهّزة صح",
      bl5_p: "موقعك والبرامج اللي وراه، مجهّزة صح من أول مرة — عشان تركّز على العمل، مو على الأدوات.",
      bl6_t: "شريك يكبر معك",
      bl6_p: "ما نختفي بعد ما تنطلق. مع نموّك، ننظّم ونحسّن ونصون اللي يشتغل لك — موقعك، وكلاء الذكاء الاصطناعي، سير العمل، التواصل، قمع المبيعات، وأكثر.",
      ...
      proof_h2: "نعرف وين تتعثّر المنشآت مثل منشأتك.",
