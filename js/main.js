...
(function () {
  ...
  const I18N = {
    en: {
      ...
      hero_h1: 'Turn your small business into a winning brand — with world-class <span class="accent">Systems</span> &amp; <span class="accent">AI agents</span>.',
      hero_sub: "First we build the systems that make your business run like a well-oiled machine — calm, consistent, and finally under control. Then we supercharge it with AI agents and smart workflows that carry the load, so you pull clear of the competition and grow fast.",
      ...
      stats_kicker: 'The AI opportunity',
      stats_h2: "AI is changing the game for small businesses.",
      stats_sub: '',
      found_kicker: 'But first — the foundation',
      found_h2: "AI can't fix a broken business. It just breaks it faster.",
      found_sub: "Bolt AI onto chaos and all you get is faster chaos. It only pays off on a solid foundation — clear, simple systems that make your business flow: happier customers, sharper efficiency, real savings, and work that finally runs without you. We build that first. Then AI takes you to another level.",
      ...
      stats_foot: "Your competitors are already adopting AI. The ones who pair it with solid systems will pull ahead — and stay there. The sooner you start, the bigger your lead.",
      ...
      ai_intro: "AI is the biggest edge a small business can get right now. We put agents and automations to work inside your systems — answering customers, chasing follow-ups, clearing the repetitive work — so your team moves faster and does far more.",
      ...
      proof_more: "See all case studies →",
      cs_title: "Case studies — Green Oaisys",
      cs_h1: "How we turn everyday chaos into calm, systemised businesses.",
      cs_sub: "Real, common problems in each industry — and exactly what changes once the right systems and AI agents are in place. This is what your business could look like.",
      cs_cta_h: "Want this for your business?",
      cs_cta_p: "Every one of these starts the same way — a free Business X-Ray that shows you exactly where your time and money leak, and the first systems to build.",
      cs_cta_btn: "Book your free Business X-Ray",
      ...
      pb_price: "SAR 1,000", pb_price_old: "SAR 6,799", pb_promo: "Founding-member offer — live in 2 weeks",
      ...
      pb_5: "Then we stay on as your systems partners — on a simple monthly retainer",
      pb_btn: "Claim the founding offer",
      pb_foot: "Your SAR 1,000 build fee is credited to your first month on retainer.",
    ...
    ar: {
      ...
      hero_h1: 'حوّل منشأتك الصغيرة إلى علامة ناجحة — مع <span class="accent">أنظمة</span>&nbsp;<span class="accent">ووكلاء ذكاء اصطناعي</span> بمستوى عالمي.',
      hero_sub: 'نبدأ ببناء الأنظمة اللي تخلّي شغلك يمشي مثل الساعة — منظّم، ثابت، وأخيرًا تحت السيطرة. وبعدها نضاعف أداءه بوكلاء ذكاء اصطناعي وسير عمل ذكي يشيلون عنك الحِمل، عشان تسبق منافسينك وتكبر بسرعة.',
      ...
      wa_caption: 'تعيش نفس الفوضى؟ نرتّبها لك — وتتفرّغ للنمو.',
      ...
      stats_kicker: 'الفرصة',
      stats_h2: 'الذكاء الاصطناعي يغيّر قواعد اللعبة للمنشآت الصغيرة.',
      stats_sub: '',
      found_kicker: 'بس قبل أي شي — الأساس',
      found_h2: 'الذكاء الاصطناعي ما يصلح منشأة فوضوية — بس يسرّع فوضاها.',
      found_sub: 'تركّب الذكاء الاصطناعي على الفوضى، يطلع لك فوضى أسرع. ما يعطي نتيجة إلا على أساس متين — أنظمة واضحة وبسيطة تخلّي شغلك ينساب: عملاء أسعد، كفاءة أعلى، توفير حقيقي، وشغل يمشي بدونك. نبني هذا الأساس أول، وبعدها الذكاء الاصطناعي يوصّلك لمستوى ثاني.',
      ...
      stats_foot: 'منافسينك بدأوا فعلًا يدخلون الذكاء الاصطناعي. واللي يجمعونه مع أنظمة قوية بيتقدّمون ويثبتون في المقدّمة — وكل ما بدّرت، زاد فرقك عنهم.',
      ...
      ai_intro: 'الذكاء الاصطناعي أكبر ميزة تقدر تحصلها منشأة صغيرة اليوم. نشغّل وكلاء وأتمتة جوّا أنظمتك — يردّون على العملاء، يتابعون، ويخلّصون الشغل المتكرر — فيصير فريقك أسرع وينجز أضعاف.',
      ...
      proof_more: "شاهد كل الأمثلة ←",
      cs_title: "أمثلة عملية — غرين أويسِس",
      cs_h1: "كيف نحوّل فوضى اليوم إلى منشآت منظّمة وهادية.",
      cs_sub: "مشاكل حقيقية ومتكررة في كل مجال — وبالضبط وش يتغيّر لما تكون الأنظمة والذكاء الاصطناعي الصح موجودة. كذا ممكن يصير شكل منشأتك.",
      cs_cta_h: "تبيها لمنشأتك؟",
      cs_cta_p: "كل مثال منها يبدأ بنفس الطريقة — فحص مجاني لمنشأتك يوريك بالضبط وين يتسرب وقتك وفلوسك، وأول الأنظمة اللي تبنيها.",
      cs_cta_btn: "احجز فحص منشأتك المجاني",
      ...
      pb_price: "1,000 ريال", pb_price_old: "6,799 ريال", pb_promo: "عرض العملاء المؤسّسين — جاهز خلال أسبوعين",
      ...
      pb_5: "وبعدها نكمّل معك كشركاء أنظمة — باشتراك شهري بسيط",
      pb_btn: "احجز عرض التأسيس",
      pb_foot: "رسوم البناء 1,000 ريال تُخصم من أول شهر في الاشتراك.",
