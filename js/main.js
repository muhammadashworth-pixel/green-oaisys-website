...
(function () {
  ...
  const I18N = {
    en: {
      ...
      hero_kicker: 'Turning Saudi businesses into brands — one system at a time',
      hero_h1: 'We build <span class="accent">systems</span> for Saudi SMEs.',
      ...
      vision_text: 'Systems excellence, in every Saudi SME.',
      ...
      offers_kicker: "How it works",
      offers_h2: "You see the money before you spend a riyal.",
      offers_sub: "No retainers. No lock-in. Each step pays for the next — or you don't take it.",
      ...
      xray_sub: "We take a limited number of Saudi businesses each month. If you're a fit, you get a complete diagnosis of your business — leaks, bottlenecks, and a 30-day plan — for free. No pitch, no fee, no obligation.",
      xray_step1_t: "1 · Apply in 60 seconds",
      ...
      xray_step2_t: "2 · Free call — the diagnosis",
      ...
      xray_step3_t: "3 · Free call — your Business X-Ray",
      xray_step3_p: "We come back with your full report: every leak ranked by cost, your operation mapped on one page, and a 30-day plan. Yours to keep.",
      xray_step4_t: "4 · Optional — we build it",
      xray_step4_p: "Like the plan? We build it: workflows, tools, AI on the busywork, your team trained. Custom scope, only if you want it.",
      ...
      founders_sub: 'We bring big-company operating discipline to Saudi SMEs — making work visible, giving it owners and standards, and putting AI on the repetition. So the business runs, grows, and holds value on its own.',
      mvv1_t: 'Our vision', mvv1_p: 'A culture of systems excellence in every Saudi SME.',
      ...
      founder1_bio: "Muhammad builds growth machines. Careem, Keeta, and a career across operations, sales, and marketing taught him one thing: leading businesses aren't run by heroes — they're run by systems. Now he builds them for Saudi SMEs.",
      ...
      footer_tag: 'Turning Saudi businesses into brands — one system at a time.',
    ...
    ar: {
      ...
      vision_label: 'رؤيتنا',
      vision_text: 'ثقافة التميّز التشغيلي في كل منشأة سعودية.',
      ...
      offers_kicker: "كيف نشتغل معك",
      offers_h2: "تشوف الفلوس قبل ما تدفع ريال.",
      offers_sub: "بلا اشتراكات وبلا التزام طويل. كل خطوة تغطّي تكلفة اللي بعدها — أو ما تاخذها.",
      ...
      xray_sub: "نستقبل عددًا محدودًا من المنشآت السعودية كل شهر. إذا كنت مناسبًا، تحصل على تشخيص كامل لمنشأتك — التسريبات والاختناقات وخطة 30 يوم — مجانًا. بلا عرض بيعي، بلا رسوم، بلا التزام.",
      xray_step1_t: "١ · قدّم في 60 ثانية",
      xray_step1_p: "عطنا اسمك واسم منشأتك ورقم واتساب وأكبر صداع يواجهك. ما ناخذ إلا المنشآت اللي نقدر نساعدها فعلًا.",
      xray_step2_t: "٢ · مكالمة مجانية — التشخيص",
      xray_step2_p: "٣٠ دقيقة مركّزة. نغوص في كيف تشتغل منشأتك فعلًا، ونلقى وين تتسرب الوقت والفلوس، ونشوف هل نحن مناسبون لك.",
      xray_step3_t: "٣ · مكالمة مجانية — فحص منشأتك",
      xray_step3_p: "نرجع لك بتقريرك الكامل: كل تسريب مرتّب حسب كلفته، وعملياتك في صفحة واحدة، وخطة 30 يوم — لك تحتفظ فيها.",
      xray_step4_t: "٤ · اختياري — ننفّذها لك",
      xray_step4_p: "عجبتك الخطة؟ نبنيها: مسارات عمل، وأدوات، وذكاء اصطناعي على المتكرر، وفريق مدرّب. نطاق مخصّص، فقط لو رغبت.",
      ...
      founders_sub: 'جينا عشان نحط انضباط الشركات الكبرى بين يدي المنشآت السعودية: نخلي الشغل مرئي، له مالك ومعيار، ونعطي التكرار للذكاء الاصطناعي — عشان منشأتك تشتغل وتكبر ويصير لها قيمة حقيقية.',
      mvv1_t: 'رؤيتنا', mvv1_p: 'ثقافة تميّز تشغيلي في كل منشأة سعودية.',
      ...
      founder1_bio: 'محمد يبني محركات النمو: كريم، كيتا، ومسيرة في العمليات والمبيعات والتسويق علّمته درس واحد — الشركات الرائدة ما يديرها أبطال، تديرها أنظمة. واليوم يبنيها لمنشآت السعودية.',
      ...
      doc_title: 'غرين أويسِس | أنظمة عمل للمنشآت السعودية',
